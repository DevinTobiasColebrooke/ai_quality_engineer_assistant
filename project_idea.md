I want to make a standalone QA engineer application that I can install on macOS/windows/Linux that gives the user to use opencode, claude, or cursor and a playwright testing agent so manual testers get assistance when testing a web application, etc.
